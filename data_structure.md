...
7.  TODO:  Has a Monte Carlo Sample ID, a Method ID, and then results.  Results should include location estimate (x,y,z), error (x,y,z, Horz, vert, and 3D), protection level (all levels?), and alerts?  Do we also want which satellites were excluded?  Need to decide on this
