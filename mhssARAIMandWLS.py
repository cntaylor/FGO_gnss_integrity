...
while i < 200:
	...
	if (chanceFault < .1):
		...
		data.GNSS.carrierSmoothPR[i,satFault1] = data.GNSS.carrierSmoothPR[i,satFault1] + 10
		...
		if (chanceFault2 < .1):
			...
			failSat2 = satFault2
			data.GNSS.carrierSmoothPR[i,satFault2] = data.GNSS.carrierSmoothPR[i,satFault2] + 10
